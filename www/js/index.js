...
var app = {
                ...
                for (var i = 0; i < contents.length; i++) {
                    if(titles[i].hasOwnProperty('a')){
                        if(all_titles.indexOf(titles[i].a.content) == -1){
                            ...
                            title_text = app.replaceAll('\n', '', app.replaceAll('&#39;', '\'', titles[i].a.content));
                        ...
                        //image_url = divContents[j].a.href
                            ...
                            content_text = app.getContent(contents[i]);
                      ...
                      stories += "</div>";
                              stories += "<div class='col-sm-10 col-xs-9 col-md-11 text' style='height:60px !important;'>";
                                ...
                                stories += "<div class='content_desc'>"+ app.replaceAll('Photo: ', '', content_text) + "</div>";
                                if (video != null)
    ...
    getContent: function(){
        ...
        if(content != undefined && content != "undefined") 
              return app.replaceAll('&#39;', '\'', app.replaceAll('See more photos after the cut...', '', app.replaceAll('\n', '', content)));
        else
